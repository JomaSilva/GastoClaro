      ...
      <div className="w-full max-w-md space-y-8 rounded-[2.5rem] border border-white/20 bg-white/50 p-10 shadow-2xl backdrop-blur-xl dark:border-zinc-800/50 dark:bg-zinc-900/50">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
            {redirectTo.startsWith('/payment')
              ? 'Entre para concluir a assinatura do seu plano'
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <button
            ...
            disabled={submitting}
            className={cn(
              'flex w-full items-center justify-center gap-2 rounded-xl gold-gradient-bg py-3 text-sm font-semibold text-white transition-all hover:opacity-90 active:scale-95',
